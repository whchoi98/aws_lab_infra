...
export class Vpc02Stack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    new ec2.CfnInstance(this, 'Vpc02InstanceA2', {
      instanceType: 't4g.large',
      imageId: amznLinux2023.getImage(this).imageId,
      subnetId: this.privateSubnetA.ref,
      securityGroupIds: [ec2Sg.ref],
      iamInstanceProfile: instanceProfile.ref,
      userData: cdk.Fn.base64(userData.render()),
      tags: [{ key: 'Name', value: 'lab-vpc02-private-ec2-a02' }, ...this.toTags(tags)],
    });

    new ec2.CfnInstance(this, 'Vpc02InstanceB2', {
      instanceType: 't4g.large',
      imageId: amznLinux2023.getImage(this).imageId,
      subnetId: this.privateSubnetB.ref,
      securityGroupIds: [ec2Sg.ref],
      iamInstanceProfile: instanceProfile.ref,
      userData: cdk.Fn.base64(userData.render()),
      tags: [{ key: 'Name', value: 'lab-vpc02-private-ec2-b02' }, ...this.toTags(tags)],
    });
